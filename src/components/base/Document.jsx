...
export const Document = (props) => {
    const {
        actNumber, removalAndRegistrationDate, violationType, actionStatus, department, meterSize, region, city, house,
    } = props;
            ...
            <div className="p-20 grid grid-cols-2 gap-10">
                <div>
                    ...
                    {/*     Write more values here
                        Value names are in the props object
                        Value placed in the <p> tag and be in first column*/}
                </div>
