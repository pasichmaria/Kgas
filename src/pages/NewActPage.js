...
export const NewActPage = ({ user }) => {
  ...
  return (
    <Box sx={{
      height: '1', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', m: 8
          ...
          <Grid container spacing={4}>
            ...
            <Grid sx={{ spacing: 2 }} item xs={6}>
              ...
              <Grid container spacing={2} marginTop={3}>
                ...
                {formik.values.region_id && !isDepartmentsLoading && departments && (<Grid item xs={12}>
                    ...
                    >
                      ...
                      {departments.map((department) => (<MenuItem key={department.id} value={department.id}>
                          {department.department_name}
                        </MenuItem>))}
                    </Select>
                  </Grid>)}

                {formik.values.department_id && (<Grid item xs={12}>
                    <Autocomplete
                      clearOnEscape={true}
                ...
                {formik.values.city_id && (<Grid item xs={12}>
                    <Autocomplete
                      clearOnEscape={true}
            ...
            <Grid sx={{ spacing: 2 }} item xs={6}>
              ...
              <Grid container spacing={2} marginTop={5}>
                ...
                {formik.values.contractor_type_id && (<Grid item xs={12}>
